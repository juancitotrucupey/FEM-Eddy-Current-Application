...
namespace MyPolynomials
{
  ...
  //_________________________________________________integratedLegendre__________________________________________________
  ...
  //_________________________________________________integratedLegendre,end__________________________________________________
