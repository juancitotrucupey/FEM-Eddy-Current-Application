...
namespace MyVectorTools
{
  ...
  double calcErrorHcurlNorm(const DH &dof_handler, //DH puntero a dof_handler, clase de Deal.ii
                            const Vector<double> &solution, //Vector<> clase de Deal.ii
                            const EddyCurrentFunction<dim> &exact_solution); //EddyCurrentFunction<> clase definida en curlfunction.h
